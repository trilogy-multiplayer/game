...
bool c_hook_crashfix::hook()
{
	...
	if (hook_result) {
		auto crash_fix_3 = memory::find_pattern<crash_fix_3_t>(memory::module_t(nullptr), "c_memory::crash_fix_3", "48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 57 41 54 41 55 41 56 41 57 48 81 EC ? ? ? ? 0F 29 70 C8 4C 8D 25 ? ? ? ?");
